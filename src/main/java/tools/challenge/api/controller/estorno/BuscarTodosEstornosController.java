...
@Tag(name = "Estornos")
public class BuscarTodosEstornosController extends ApiListController {
    ...
    @GET
    @Operation(
            summary = "Lista todos os estornos",
            description = "Lista todas as transações de estornos cadastrados em banco de dados"
    )
    @APIResponses(
            value = {
                    @APIResponse(
