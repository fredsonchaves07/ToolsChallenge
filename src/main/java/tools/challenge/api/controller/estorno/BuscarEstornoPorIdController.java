...
@Tag(name = "Estornos")
public class BuscarEstornoPorIdController extends ApiGetController {
    ...
    @GET
    @Operation(
            summary = "Obtem estorno",
            description = "Obtem e recupera informações de transação de estorno ao informar o id"
    )
    @APIResponses(
            value = {
                    @APIResponse(
